 ...
 * @author user
 */
public class ReceiptSell extends javax.swing.JFrame {
    ...
    String orderNo, firstName, lastName, contactNo, email, stringProducts, stringPrices, sellingDate;
    
    public ReceiptSell() {
        initComponents();
    }
    
   public ReceiptSell(String _sellingNo, String _firstName, String _lastName, String _contactNo, String _email, 
            String _stringProducts, String _stringPrices, double _total, String _sellingDate, double _cash, double _card) {
        initComponents();
       
        this.orderNo = _sellingNo;
    ...
    public void loadOrderToPrint()
    {
        ...
        lbl_order_picked_on.setText("Date: " + sellingDate);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(returningResult)
        {
            try {
                ...
                Logger.getLogger(ReceiptSell.class.getName()).log(Level.SEVERE, null, ex);
                this.dispose();
            }
...
//<editor-fold defaultstate="collapsed" desc=" Look and feel setting code (optional) ">
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReceiptSell.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReceiptSell().setVisible(true);
            }
        });
    }
