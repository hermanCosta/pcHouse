...
public class Receipt extends javax.swing.JFrame {
    ...
    String orderNo, firstName, lastName, contactNo, email, deviceBrand, deviceModel, serialNumber, payDate;
    
    public Receipt() {
        initComponents();
    }
    
    Receipt(String _orderNo, String _firstName, String _lastName, String _contactNo, String _email, 
            String _deviceBrand, String _deviceModel, String _serialNumber, JTable _tableProducts, 
    ...
    public void loadOrderToPrint()
    {
        ...
        for (int i = 0; i < tableProducts.getRowCount(); i++)
        {
            ...
            txt_area_product_service.setText(txt_area_product_service.getText() + " - " + product + "\n");
        }
    }
