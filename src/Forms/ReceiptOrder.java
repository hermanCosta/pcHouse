...
public class ReceiptOrder extends javax.swing.JFrame {
    ...
    public ReceiptOrder(String _orderNo, String _firstName, String _lastName, String _contactNo, String _email, 
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(returningResult)
        {
            try {
                ...
                Logger.getLogger(ReceiptOrder.class.getName()).log(Level.SEVERE, null, ex);
                this.dispose();
            }
