...
public class Receipt extends javax.swing.JFrame {
    ...
    String orderNo, firstName, lastName, contactNo, email, deviceBrand, deviceModel, stringProducts, serialNumber, payDate;
    
    public Receipt() {
        initComponents();
    }
    
    public Receipt(String _orderNo, String _firstName, String _lastName, String _contactNo, String _email, 
            String _deviceBrand, String _deviceModel, String _serialNumber, String _stringProducts, 
            double _total, double _deposit, double _due, String _payDate) {
    ...
    public void loadOrderToPrint()
    {
        ...
        lbl_issue_date.setText("Issued on: " + payDate);
        lbl_paid_by.setText("Paid by: ");
        
        String[] arrayProducts = stringProducts.split(",");
        for (String s : arrayProducts)
        {
            txt_area_product_service.setText(txt_area_product_service.getText() +" - " + s + " \n");
        }
    }
    ...
    private void initComponents() {
        ...
        lbl_issue_date.setFont(new java.awt.Font("Lucida Grande", 0, 11)); // NOI18N
        lbl_issue_date.setText("issueDate");
            ...
            .addGroup(panel_print_orderLayout.createSequentialGroup()
                ...
                .addGroup(panel_print_orderLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(panel_print_orderLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(lbl_issue_date, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
        ...
        jLabel3.setText("Payment Receipt Print View");
